...
try:
    conn = mysql.connector.connect(
           host='nasje319.mysql.pythonanywhere-services.com',
           user='nasje319',
           password='mysqlroot'
      )
...
cursor.execute("DROP DATABASE IF EXISTS `nasje319$pedidoEntrega`;")

cursor.execute("CREATE DATABASE `nasje319$pedidoEntrega`;")

cursor.execute("USE `nasje319$pedidoEntrega`;")
...
cursor.execute('select * from nasje319$pedidoEntrega.usuarios')
print(' -------------  Usuarios:  -------------')
...
cursor.execute('select * from nasje319$pedidoEntrega.productos')
print(' -------------  Productoss:  -------------')
